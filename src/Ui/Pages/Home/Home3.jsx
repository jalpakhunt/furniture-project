      ...
      <section className="section-slide">
        <div className="wrap-slick1 rs2-slick1">
          <div className="slick1">
            ...
            <div
              className="item-slick1 bg-overlay1"
              style={{backgroundImage: "url(images/slide-06.jpg)"}}
              data-thumb="images/thumb-02.jpg"
            ...
            <div
              className="item-slick1 bg-overlay1"
              style={{backgroundImage: "url(images/slide-07.jpg)"}}
              data-thumb="images/thumb-03.jpg"
              data-caption="Men’s Wear"
            >
              <div className="container h-full">
                <div className="flex-col-c-m h-full p-t-100 p-b-60 respon5">
